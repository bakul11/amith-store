...
const NotFound = () => {
    return (
        <div className='px-5 lg:px-12 my-28 text-center'>
            ...
            <Link href='/' className='bg-blue-500 font-semibold uppercase inline-block text-white hover:bg-orange-500 transition-all ease-in-out duration-[0.5s] rounded-md py-2 px-3 outline-none'>
